        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-2xl bg-white/5 ring-1 ring-white/10 p-6">
            ...
            <p className="mt-3 text-white/75">
              ...
              <strong className="text-white">service</strong>. Créez aussi un <strong className="text-white">événement</strong>.
            </p>
            <ul className="mt-4 space-y-1.5 text-white/75">
          ...
          <div className="rounded-2xl bg-white/5 ring-1 ring-white/10 p-6">
            ...
            <p className="mt-3 text-white/75">
              Un “OK” suffit. BOB crée l’échange et synchronise les statuts des deux côtés.
            </p>
            <ul className="mt-4 space-y-1.5 text-white/75">
              <li>• Suivi partagé</li>
