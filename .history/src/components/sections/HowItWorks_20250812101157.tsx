      ...
      <Container>
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-3 text-white/80">
            En trois gestes simples : <span className="text-white">choisir un proche</span>,{' '}
            <span className="text-white">envoyer en privé</span>, <span className="text-white">laisser BOB rappeler</span>.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          ...
          <div className="rounded-2xl bg-white/5 ring-1 ring-white/10 p-6 h-full">
            ...
            <p className="mt-3 text-white/75">
              ...
              <strong className="text-white">service</strong> ou créez un <strong className="text-white">événement</strong>.
            </p>
            <ul className="mt-4 space-y-2 text-white/75">
              <li>• Message direct (SMS, messagerie) depuis l’app</li>
