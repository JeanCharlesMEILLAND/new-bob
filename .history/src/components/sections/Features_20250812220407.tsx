...
export default function Features() {
  return (
      <section id="features" className="section pt-16 z-50 block">
        <div
            className="
          relative
          mx-auto max-w-7xl
        ...
        >
          ...
          <FeaturesCard
              ...
              description="Discutez en tête-à-tête pour vos échanges ou utilisez le chat pour coordonner l’événement."
          />
