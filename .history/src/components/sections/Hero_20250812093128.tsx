    ...
    <section className="relative section pt-36">
      ...
      <Container className="text-center">
        ...
        <h1 className="mt-6 text-5xl font-extrabold tracking-tight sm:text-6xl">
          <span className="gradient-text">BOB</span> — Votre Assistant Personnel d’Échanges
        </h1>
        ...
        <p className="mx-auto mt-6 max-w-3xl text-lg text-white/80">
          ...
          uniquement avec vos contacts. Pas de paiements, pas d’annuaire public.
        </p>

        {/* Call-to-actions */}
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <Button href="#waitlist" variant="primary" size="lg" ariaLabel="Rejoindre la liste d’attente">
            Essayer BOB
          </Button>
        ...
        {/* Mini “pills” de fonctions clés (Objets / Services / Événements) */}
        ...
        {/* Cadre de visuel (remplace par ta capture) */}
        <div
          aria-hidden="true"
