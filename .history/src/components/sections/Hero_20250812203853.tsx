...
export default function Hero() {
  return (
      <section className="relative pt-28 pb-4"> {/* ↓ avant pt-48, donc badge + haut */}
        ...
        <div
            className="absolute inset-0 -z-20 bg-grid opacity-[0.25] [mask-image:radial-gradient(circle at center,black,transparent_70%)]"/>
        ...
        <Container className="text-center space-y-10 relative z-10">
          ...
          <h1 className="mt-22 text-5xl tracking-tight sm:text-6xl leading-tight text-accent">
            <span
                className="bg-gradient-to-tr from-[#00C9F7] to-[#166AF6] bg-clip-text text-transparent font-extrabold">Bober</span>,
          ...
          {/* Légende rapprochée */}
          <p className="text-base text-accent text- -mt-2">Disponible sur iOS et Android</p>
