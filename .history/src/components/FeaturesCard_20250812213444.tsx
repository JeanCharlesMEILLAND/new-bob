    ...
    <div className={clsx('w-full flex justify-center', wrapperClassName)}>
      <article
        className={clsx(
          ...
          // ↓ padding vertical réduit, padding horizontal conservé
          'px-12 py-4 flex items-start gap-5 transition-transform will-change-transform',
      ...
      >
        {/* Icône */}
        <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-[#E8F0FF] ring-1 ring-[#4b7bff]/20 shrink-0 mt-1">
