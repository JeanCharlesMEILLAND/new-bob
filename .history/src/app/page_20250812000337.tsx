    ...
    <main className="bg-white text-gray-900">
      ...
      <section id="prive" className="py-20 bg-gray-50 border-y border-gray-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-gray-900">Pensé pour rester privé</h2>
            <p className="mt-4 text-gray-800 leading-relaxed">
              Avec BOB, votre confidentialité est une priorité. L’application est conçue pour que vos échanges restent personnels et protégés, sans jamais être visibles publiquement.
            </p>
            <ul className="mt-6 space-y-3 text-gray-800">
              {[
                "Aucun catalogue public",
                "Aucun profil visible par des inconnus",
                "Aucune mise en relation automatique",
          ...
          <div className="rounded-2xl border border-gray-300 bg-white p-6 shadow-sm">
            <h3 className="font-semibold text-gray-900">Exemples d’infos que BOB retient</h3>
            ...
            <p className="mt-4 text-sm text-gray-700">
              Ces infos restent dans <strong>ton</strong> application — invisibles pour les autres.
            </p>
          </div>
        </div>
      </section>
