    ...
    <html lang="fr">
      <body className="antialiased bg-white text-gray-900">
        ...
        <header className="sticky top-0 z-50 backdrop-blur bg-white/95 border-b border-gray-200 shadow-sm">
          <div className="container h-16 flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6">
              <a href="#fonctionnement" className="text-sm text-gray-900 hover:text-indigo-700">Fonctionnement</a>
              <a href="#prive" className="text-sm text-gray-900 hover:text-indigo-700">Pensé pour rester privé</a>
              <a href="#telecharger" className="text-sm text-gray-900 hover:text-indigo-700">Télécharger</a>
              <Link href="/conditions-utilisation" className="text-sm text-gray-900 hover:text-indigo-700">Conditions</Link>
              <Link href="/confidentialite" className="text-sm text-gray-900 hover:text-indigo-700">Confidentialité</Link>
            </nav>

            {/* CTA */}
            <a href="#telecharger" className="btn-primary">Commencer</a>
          </div>
        </header>
        ...
        <footer className="py-8 border-t border-gray-200 text-center text-sm text-gray-700">
          ...
          <a href="#prive" className="text-indigo-600 hover:underline">Pensé pour rester privé</a> ·{" "}
          <Link href="/conditions-utilisation" className="text-indigo-600 hover:underline">Conditions</Link> ·{" "}
          <Link href="/confidentialite" className="text-indigo-600 hover:underline">Confidentialité</Link>
        </footer>
      </body>
    </html>
  );
