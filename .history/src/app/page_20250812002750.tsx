        ...
        <div className="container py-24 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="mt-6 text-lg text-gray-700 leading-relaxed max-w-xl">
              Proposez ou demandez des objets, lancez un coup de main, organisez un événement. Tout est privé et visible uniquement par vos contacts invités.
            </p>
          ...
          <div className="relative">
            <div className="aspect-[9/16] w-80 mx-auto rounded-[2.5rem] border border-gray-200 bg-white shadow-2xl p-6 overflow-hidden">
              <div className="h-12 rounded-lg bg-indigo-100 grid place-items-center text-indigo-800 text-sm font-medium mb-4">
            ...
            <div className="absolute -z-10 -top-10 -left-10 w-40 h-40 bg-indigo-200 rounded-full blur-3xl opacity-50"></div>
            <div className="absolute -z-10 bottom-0 -right-10 w-40 h-40 bg-purple-200 rounded-full blur-3xl opacity-50"></div>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                desc:
                  "📤 Proposer un objet à une personne précise • 📥 Demander un objet ciblé • Historique automatique pour ne rien oublier."
              },
              {
                title: "BOBER des services",
                desc:
                  "📤 Proposer ton aide (bricolage, jardinage…) • 📥 Demander un coup de main précis • Conversation directe."
              },
              {
                title: "Événements privés",
                desc:
                  "Crée un événement, invite des proches, chat collectif. Chacun se positionne sur la liste (objets, consommables, services)."
              },
              {
                title: "Agenda & rappels",
                desc:
                  "Création automatique d’échanges individuels + rappels dans ton agenda. Retour d’objets et suivis facilités."
              },
            ].map((f) => (
      ...
      <section className="py-20">
        <div className="container grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2 relative">
            <div className="aspect-[16/10] rounded-2xl border border-gray-200 bg-white shadow-xl grid place-items-center text-sm text-gray-600">
              Aperçu événement · Liste : <em>chaises, plancha, boissons, aide tonnelle…</em>
            </div>
            <div className="absolute -z-10 -top-8 -right-8 w-36 h-36 bg-indigo-200 rounded-full blur-3xl opacity-50"></div>
          </div>
        </div>
      </section>
