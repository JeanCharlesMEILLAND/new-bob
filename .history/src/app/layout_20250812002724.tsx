        ...
        <header className="sticky top-0 z-50 backdrop-blur bg-white/95 border-b border-gray-200 shadow-soft">
          <div className="container h-16 flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6">
              <a href="#fonctionnement" className="text-sm text-gray-900 hover:text-brand-dark">Fonctionnement</a>
              <a href="#prive" className="text-sm text-gray-900 hover:text-brand-dark">Pensé pour rester privé</a>
              <a href="#telecharger" className="text-sm text-gray-900 hover:text-brand-dark">Télécharger</a>
              <Link href="/conditions-utilisation" className="text-sm text-gray-900 hover:text-brand-dark">Conditions</Link>
              <Link href="/confidentialite" className="text-sm text-gray-900 hover:text-brand-dark">Confidentialité</Link>
            </nav>
