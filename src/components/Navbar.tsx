  ...
  return (
    ...
    >
      <Container className="flex items-center justify-between py-4">
        <Link href="/" className="flex items-center gap-2" aria-label="Accueil Bob App">
          <Logo />
          <span className="sr-only">Bob App</span>
        </Link>

        <nav aria-label="Navigation principale" className="hidden md:flex items-center gap-6 text-sm text-white/80">
        ...
        <div className="flex items-center gap-3">
          <Button href="#waitlist" variant="primary" size="sm" className="hidden md:inline-flex">
