  ...
  return (
    <Container className="mt-16 relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center -z-10 overflow-hidden rounded-3xl">
        <Image
          src="/circle-small.webp"          // small, optimized asset
          alt=""
          width={206}
          height={190}
      ...
      >
        <div className="relative z-10 h-fit">
          ...
          <div className="text-white space-y-4 sm:space-y-6 md:w-1/2 md:pr-10">
            ...
            >
              With BOB, organizing private exchanges becomes simple and well-tracked. The app is{" "}
              <strong>100% free</strong>, with no payments or subscriptions, and all features included.
            </motion.p>
          ...
          {/* Right visual (keep dimensions close to display size) */}
          <motion.div
          ...
          >
            <Image
              src="/group-app-preview.webp"   // ~280x170 optimized export
              alt="Smartphone preview of the BOB app"
              width={280}
              height={170}
