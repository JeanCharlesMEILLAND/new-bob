...
export const FeaturesHighlight = () => {
  return (
      <Container
          className="relative rounded-3xl bg-gradient-to-tr from-[#166DF6] to-[#05B1F5] mt-16">
          ...
          <div className="relative z-10 h-fit">
            ...
            <div className="text-white space-y-6 md:w-2/3 md:pr-10">
              ...
              <p className="text-white/95 leading-relaxed max-w-2xl">
                Avec BOB, créez <strong className={"font-bold"}>des événements</strong> privés pour vos proches et gérez
                tout
            ...
            <div className="mt-8 md:mt-0 md:absolute md:inset-y-0 md:right-0 md:w-1/3 flex items-center justify-center">
              <Image
                  src="/7%202.png"
